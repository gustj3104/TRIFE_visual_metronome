...
function SectionLabel({ text, ts }: { text: string; ts: string }) {
  return (
    <div style={{ color: ts, fontSize: '0.744rem', letterSpacing: '0.14em', fontWeight: 700, marginBottom: 8 }}>
      {text}
    </div>
  );
}
    ...
    <div style={{ display: 'flex', borderRadius: 8, overflow: 'hidden', border: `1px solid ${border}` }}>
      {opts.map(o => (
        <button
          ...
          style={{
            flex: 1, padding: '7px 4px', fontSize: '0.864rem', border: 'none', cursor: 'pointer',
...
function ToggleRow({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
      <span style={{ color: ts, fontSize: '0.876rem' }}>{label}</span>
      <button
        role="switch"
        aria-checked={value}
        aria-label={label}
            ...
            <div style={{ width: 268, height: '100%', display: 'flex', flexDirection: 'column', overflowY: 'auto', scrollbarWidth: 'none' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 16px', borderBottom: `1px solid ${pBorder}`, flexShrink: 0 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <span style={{ color: tp, fontSize: '0.936rem', fontWeight: 700, letterSpacing: '0.12em' }}>BEAT</span>
                  <span data-testid="status-badge" style={{
                    color: ts, fontSize: '0.744rem', fontFamily: "'DM Mono', monospace",
              ...
              <div style={{ padding: '16px 16px 14px', borderBottom: `1px solid ${pBorder}`, flexShrink: 0 }}>
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', marginBottom: 10 }}>
                  <div>
                    ...
                    <div style={{ color: ts, fontSize: '0.72rem', letterSpacing: '0.16em', marginTop: 4 }}>BPM</div>
                  </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: '0.84rem', letterSpacing: '0.12em', fontWeight: 600,
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6 }}>
                  {(['Bounce', 'Swing', 'Pulse', 'Sweep'] as VizType[]).map(v => (
                    <button
                      ...
                      style={{
                        padding: '8px 4px', borderRadius: 8, cursor: 'pointer', fontSize: '0.864rem',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {[
                    ...
                    <div key={key} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ color: ts, fontSize: '0.84rem' }}>{desc}</span>
                      <span style={{
                        color: tp, fontFamily: "'DM Mono', monospace", fontSize: '0.72rem',
                        padding: '2px 6px', border: `1px solid ${pBorder}`, borderRadius: 4,
                      }}>
                        {key}
                      </span>
              ...
              <div style={{ padding: '16px', marginTop: 'auto', flexShrink: 0 }}>
                <button
                  ...
                  style={{
                    ...
                    fontSize: '0.888rem', fontWeight: 700, letterSpacing: '0.1em',
